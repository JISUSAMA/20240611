...
public class Ex05Lambda01 {
  public static void main(String[] args) {
    ...
    //2) 매개변수가 1개일 때, ()는 생략 가능 /2개 이상은 생략 불가
    mi = (num)-> {};
    mi = num-> {}; //run()메서드 안에 명령이 없으면 반드시 {} 표기
    MyInterface2 mi2 = (n1,n2) -> {};

    //3) 매개변수가 있고, return type 이 있는 경우,
    MyInterface3 mi3 = (n1, n2) -> {return n1+n2;};
    mi3 = (n1, n2) -> n1+n2; //중괄호를 생략하면 return 도 생략
